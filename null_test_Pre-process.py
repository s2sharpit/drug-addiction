# [7516 rows x 11 columns]
import pandas as pd
import numpy as np

df = pd.read_csv("D:/Drug_Prediction_ML/student_addiction_dataset_test.csv")
print(df)
...
Encod_Categorize_rows = pd.read_csv("D:/Drug_Prediction_ML/student_addiction_dataset_test.csv", converters= {
...
Test_drop_rows = Encod_Categorize_rows.dropna() #Rows with null values will be dropped
print(Test_drop_rows)

#Test_drop_rows.to_csv("D:/Drug_Prediction_ML/test_drop_records.csv", index= False)
